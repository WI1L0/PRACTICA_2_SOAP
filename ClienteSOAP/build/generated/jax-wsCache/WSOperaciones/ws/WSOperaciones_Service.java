 ...
 * 
 */
@WebServiceClient(name = "WSOperaciones", targetNamespace = "http://WS/", wsdlLocation = "http://localhost:8080/SOAP_ServicioWeb/WSOperaciones?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/SOAP_ServicioWeb/WSOperaciones?WSDL");
